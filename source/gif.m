%% @package gif
%
%   @brief gif function that builds a gif animation frame-by-frame
%
%   @details Function to build a gif animation frame-by-frame. This file was
%   cloned from Greene, Chad A., et al. “The Climate Data Toolbox for 
%   MATLAB." Geochemistry, Geophysics, Geosystems, vol. 20, no. 7, 
%   American Geophysical Union (AGU), July 2019, pp. 3774–81, 
%   doi:10.1029/2019gc008392 from the Matlab File Exchange: 
%   https://www.mathworks.com/matlabcentral/fileexchange/63239-gif. It has
%   been modified to suit the purposes needed by this repository. 
%
%   @author Chad Greene
%
%   @editor Austin Ladshaw
%
%   @date 03/29/2023
%
